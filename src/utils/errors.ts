...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  PLAN_REQUIRED: "One or more filters in the request require a higher Prospeo plan. Remove the gated filters or upgrade the account to run this search.",
  ...
  NO_MATCH: "No record could be matched for the provided input. Try adding more identifying fields.",
  NO_RESULTS: "No results matched the provided search filters.",
...
const ERROR_META: Record<string, ErrorMeta> = {
  ...
  PLAN_REQUIRED: { category: "api_client_error", severity: "high" },
  RATE_LIMITED: { category: "rate_limit", severity: "medium" },
  RATE_LIMIT_EXCEEDED: { category: "rate_limit", severity: "medium" },
  NO_MATCH: { category: "api_client_error", severity: "low" },
  NO_RESULTS: { category: "api_client_error", severity: "low" },
